<div x-data="{showedit: @entangle('showPlaceEditor')}" class="py-2 max-x-4xl mx-auto ">
            ...
            <div class="py-4">
                ...
                <div x-show="showedit">
                    <x-modal.dialog wire:model="showPlaceEditor" >
                        <x-slot name="title">Hey Hey</x-slot>
                        <x-slot name="content">{{$showPlaceEditor==false}}</x-slot>
                        <x-slot name="footer">Hey Hey</x-slot>
                    </x-modal.dialog>
                </div>
            </div>
        </div>
